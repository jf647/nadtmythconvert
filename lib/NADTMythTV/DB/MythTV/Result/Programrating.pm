package NADTMythTV::DB::MythTV::Result::Programrating;
...
NADTMythTV::DB::MythTV::Result::Programrating
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2OdLAIt83m4edWhoavTWFQ
