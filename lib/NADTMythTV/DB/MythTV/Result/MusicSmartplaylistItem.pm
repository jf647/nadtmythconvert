package NADTMythTV::DB::MythTV::Result::MusicSmartplaylistItem;
...
NADTMythTV::DB::MythTV::Result::MusicSmartplaylistItem
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:P+s8diNZ0zaf4CfXKQlJAA
