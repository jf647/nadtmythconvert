package NADTMythTV::DB::MythTV::Result::Recordedprogram;
...
NADTMythTV::DB::MythTV::Result::Recordedprogram
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PyeRdiZWRi33AKQa8UU5ig
