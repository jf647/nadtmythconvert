package NADTMythTV::DB::MythTV::Result::Channelgroupname;
...
NADTMythTV::DB::MythTV::Result::Channelgroupname
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:+RpYZW/AFw16RL0QFJlMbQ
