package NADTMythTV::DB::MythTV::Result::Videosource;
...
NADTMythTV::DB::MythTV::Result::Videosource
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:/TSXWNketSd4Svstzn1gyA
