package NADTMythTV::DB::MythTV::Result::Recordedrating;
...
NADTMythTV::DB::MythTV::Result::Recordedrating
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:26vu5VDSOLoaq2NPB5A4vw
