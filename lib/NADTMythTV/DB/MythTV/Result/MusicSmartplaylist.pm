package NADTMythTV::DB::MythTV::Result::MusicSmartplaylist;
...
NADTMythTV::DB::MythTV::Result::MusicSmartplaylist
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2DA4hkTCHbIzFe9DK2aLHg
