package NADTMythTV::DB::MythTV::Result::Capturecard;
...
NADTMythTV::DB::MythTV::Result::Capturecard
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pEyvx3fZHGY2Lgwot5Kh4w
