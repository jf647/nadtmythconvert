package NADTMythTV::DB::MythTV::Result::DtvMultiplex;
...
NADTMythTV::DB::MythTV::Result::DtvMultiplex
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OBC8SoasRKQjWdk9dKsq3g
