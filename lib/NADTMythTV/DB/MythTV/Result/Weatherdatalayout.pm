package NADTMythTV::DB::MythTV::Result::Weatherdatalayout;
...
Related object: L<NADTMythTV::DB::MythTV::Result::Weatherscreen>
...
Related object: L<NADTMythTV::DB::MythTV::Result::Weathersourcesetting>

=cut

__PACKAGE__->belongs_to(
  "weathersourcesettings_sourceid",
  "NADTMythTV::DB::MythTV::Result::Weathersourcesetting",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OBHUyFhc8aV2wiXUnUIPYQ
