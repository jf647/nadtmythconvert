package NADTMythTV::DB::MythTV::Result::ChannelscanChannel;
...
NADTMythTV::DB::MythTV::Result::ChannelscanChannel
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:hiuGiR7tNs9s3Lvg0JcvoA
