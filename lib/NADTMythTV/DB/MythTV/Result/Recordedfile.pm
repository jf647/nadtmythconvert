package NADTMythTV::DB::MythTV::Result::Recordedfile;
...
NADTMythTV::DB::MythTV::Result::Recordedfile
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:TtFxx45m680voUeAQpJM7Q
